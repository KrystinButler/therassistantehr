...
exports.createSupabaseClaimRepository = createSupabaseClaimRepository;
const helpers_1 = require("./helpers");
function createSupabaseClaimRepository(db) {
    return {
        ...
        async listReadyToSubmit(organization_id) {
          ...
          `)
            ...
            return rows.map((row) => ({
                ...
                readiness_status: Array.isArray(row.last_blocker_codes) && row.last_blocker_codes.length > 0
                    ? "blocked"
                    : "ready",
