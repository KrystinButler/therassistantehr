...
exports.createSupabaseInsuranceRepository = createSupabaseInsuranceRepository;
const helpers_1 = require("./helpers");
function createSupabaseInsuranceRepository(db) {
    return {
        async getPrimaryPolicyForEncounter(organization_id, encounter_id) {
            const encounter = await (0, helpers_1.expectOne)(db
                .from("encounters")
            ...
            const appointment = await (0, helpers_1.expectOne)(db
                .from("appointments")
                .select(`
            id,
            organization_id,
          ...
          `)
            ...
            const fallbackPolicies = await (0, helpers_1.expectMany)(db
        ...
        async getLatestEligibilityForEncounter(organization_id, encounter_id) {
            ...
            const eligibility = await (0, helpers_1.expectOne)(db
